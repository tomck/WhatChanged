# Shared module release 17.0.2.4

The default archive, pendingchanges-17.0.2.4.tgz, declares FreePBX 14.0,
...
Validation: the identical 17.0.2.4 archive is installed with Module Admin in
the existing disposable FreePBX 14, 15, 16 and 17 fixtures. Each reported
17.0.2.4 Enabled. PHP 5.6, 7.4 and 8.2 syntax, page rendering, watcher-health
...
September 16, 2026. Both embedded filesystem layouts and automatic OS-family
...
Version 17.0.2.4 also records watcher payload version 0.1.9 in every embedded,
...
request-audit checks and the core watcher smoke lifecycle passed on September 16.
...
custom trunks, the watcher-health page, keyed-redaction persistence, watcher
interruption recovery, Apply Config baseline refreshes and the final clean-state
assertion.
