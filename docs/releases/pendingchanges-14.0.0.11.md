# Pending Changes Tripwire 14.0.0.11 alpha

Experimental FreePBX 14 compatibility release. FreePBX 14 and its usual host
operating systems are obsolete; test only on a backed-up, noncritical system.
