# Pending Changes Tripwire 14.0.0.12 public alpha

FreePBX 14 compatibility candidate for the WhatChanged read-only observer.
...
[legacy alpha guide](https://github.com/tomck/WhatChanged/blob/main/docs/legacy-alpha-install.md). FreePBX 14 and its underlying
