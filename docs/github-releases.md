...
| --- | --- | --- | --- |
| `pendingchanges-17.0.1.5` | 14–17 | `pendingchanges-17.0.1.5.tgz` with embedded watcher | Optional Debian and portable 0.1.4 packages |
...
git tag -a pendingchanges-17.0.1.5 -m 'Pending Changes Tripwire 17.0.1.5 alpha'
./scripts/package-watcher.sh
./scripts/package-release-signing-bundle.sh
```

The final command creates `dist/what-changed-signing-17.0.1.5.tar.gz`. It contains
...
```sh
tar -xzf what-changed-signing-17.0.1.5.tar.gz
cd what-changed-signing-17.0.1.5
