...
| --- | --- | --- | --- |
| `pendingchanges-17.0.2.0` | 14–17 | `pendingchanges-17.0.2.0.tgz` with embedded watcher | Optional Debian and portable 0.1.6 packages |
...
git tag -a pendingchanges-17.0.2.0 -m 'Pending Changes Tripwire 17.0.2.0 alpha'
./scripts/package-watcher.sh
./scripts/package-release-signing-bundle.sh
```

The final command creates `dist/what-changed-signing-17.0.2.0.tar.gz`. It contains
...
```sh
tar -xzf what-changed-signing-17.0.2.0.tar.gz
cd what-changed-signing-17.0.2.0
