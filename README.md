...
Download `pendingchanges-17.0.2.5.tgz` from the matching GitHub release,
...
if [ -d "$freepbx_webroot/admin/modules" ]; then
  sudo tar -xzf pendingchanges-17.0.2.5.tgz -C "$freepbx_webroot/admin/modules"
