...
Once published, download `pendingchanges-17.0.2.6.tgz` from the matching GitHub release,
...
if [ -d "$freepbx_webroot/admin/modules" ]; then
  sudo tar -xzf pendingchanges-17.0.2.6.tgz -C "$freepbx_webroot/admin/modules"
